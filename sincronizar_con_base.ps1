# Script de sincronización automática desde c:\laragon\www\logistica-citas hacia D:\Logistica-CItas-Base
param (
...
if ($status) {
    ...
    Write-Host "✅ Sincronización y push completados exitosamente!" -ForegroundColor Green
} else {
    Write-Host "ℹ️ No hay cambios nuevos que sincronizar. El repositorio Base ya está al día." -ForegroundColor Green
}
