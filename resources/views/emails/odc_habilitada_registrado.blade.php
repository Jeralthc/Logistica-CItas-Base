...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Le informamos que el comprador <strong>{{ $info->comprador_nombre }}</strong> ha habilitado una nueva Orden de Compra para su despacho en Hipersuraki.</p>
            ...
            <p>Para su comodidad, le recordamos su usuario de acceso:</p>
            <div class="details-box">
                <p><strong>Usuario / RIF:</strong> {{ $info->username }}</p>
                <p><strong>Correo Notificado:</strong> {{ $info->email_destino }}</p>
            </div>

            <div class="button-container">
                <a href="{{ $linkLogin }}" style="background-color: #dc2626; color: white; padding: 14px 35px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block; font-size: 16px;">Ingresar al Portal y Agendar</a>
            </div>
            ...
            <a href="{{ $linkLogin }}" style="color: #3b82f6; word-break: break-all;">{{ $linkLogin }}</a></p>
            ...
            <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 18px 20px; margin: 25px 0; text-align: center;">
                <p style="margin: 0 0 6px 0; font-size: 14px; font-weight: bold; color: #0f172a;">
                    📖 ¿Necesitas una guía o ayuda para agendar?
                </p>
                <p style="margin: 0 0 14px 0; font-size: 13px; color: #64748b; line-height: 1.5;">
                    Puedes consultar o descargar nuestro <strong>Manual de Usuario en PDF</strong> con el paso a paso detallado para gestionar tus citas de recepción.
                </p>
