                        ...
                        <form v-else @submit.prevent="guardarConfiguracion" class="space-y-6">
                            ...
                            <div v-if="form.mode === 'api'" class="grid grid-cols-1 gap-6 animate-fade-in bg-emerald-50/50 p-6 rounded-2xl border border-emerald-100">
                                <div>
                                    ...
                                    <input v-model="form.api_url" type="url" :required="form.mode === 'api'" class="block w-full border-emerald-200 focus:border-emerald-500 focus:ring-emerald-500 rounded-xl shadow-sm bg-white" placeholder="Ej: https://agente.suraki.net/api/erp">
